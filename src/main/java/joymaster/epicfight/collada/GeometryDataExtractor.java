...
public class GeometryDataExtractor
{
	...
	{
		String noramlId = node.getChild("triangles").getChildWithAttribute("input", "semantic", "NORMAL")
	...
	{
		String textureCoordId = node.getChild("triangles").getChildWithAttribute("input", "semantic", "TEXCOORD")
				.getAttribute("source").substring(1);
