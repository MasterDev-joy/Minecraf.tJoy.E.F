...
import joymaster.epicfight.animation.types.AimingAnimation;
import joymaster.epicfight.animation.types.AnimationProperty;
import joymaster.epicfight.animation.types.DodgingAnimation;
import joymaster.epicfight.animation.types.HitAnimation;
import joymaster.epicfight.animation.types.ImmovableAnimation;
import joymaster.epicfight.animation.types.MirrorAnimation;
import joymaster.epicfight.animation.types.MovementAnimation;
import joymaster.epicfight.animation.types.ReboundAnimation;
import joymaster.epicfight.animation.types.StaticAnimation;
import joymaster.epicfight.animation.types.VariableHitAnimation;
import joymaster.epicfight.animation.types.attack.AAAnimation;
import joymaster.epicfight.animation.types.attack.AADashAnimation;
import joymaster.epicfight.animation.types.attack.AttackAnimation;
import joymaster.epicfight.animation.types.attack.MountAttackAnimation;
import joymaster.epicfight.animation.types.attack.SpecialAttackAnimation;
import joymaster.epicfight.animation.types.attack.TargetTraceAnimation;
import joymaster.epicfight.animation.types.attack.AttackAnimation.Phase;
import joymaster.epicfight.capabilities.entity.mob.MobAttackPatterns;
